...
export class SimulationDialog{
 ...
 render(focus){
  ...
  const target=focus&&this.dialog.querySelector(focus);if(target&&!target.disabled)target.focus();else if(focus)(this.dialog.querySelector('.sim-controls button:not(:disabled)')||this.dialog.querySelector('[data-view="notes"]'))?.focus();
 }
