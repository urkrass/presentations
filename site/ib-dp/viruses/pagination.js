...
export function blockHtml(b){
 if(b.type==='simulation')return `<div class="reading-block simulation-card"><strong>${E(SIMULATION_TITLES[b.name])}</strong><p>A live, playable biological model.</p><button class="primary" data-simulation="${E(b.name)}">Open simulation ↗</button></div>`;
