...
buildDeck('decks/grade-8-mole-history/slides.md', publicPath('/grade-8/mole-history/'), path.join(dist, 'grade-8', 'mole-history'))
...
addRouteRecovery(path.join(dist, 'grade-8', 'mole-history'))
