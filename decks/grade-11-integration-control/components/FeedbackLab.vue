...
.loop-stage { min-height: 335px; padding: 25px; display: grid; grid-template-columns: repeat(7,auto); gap: 10px; align-items: center; border-radius: 7px; background: var(--blue-field); }.loop-stage > div { width: 200px; min-height: 170px; padding: 18px; display: grid; align-content: center; gap: 13px; border-radius: 6px; background: rgba(255,255,255,.72); }.loop-stage > b { color: var(--accent); font: 700 26px/1 var(--serif); }.loop-stage span { color: var(--accent); font-size: 11px; font-weight: 800; letter-spacing: .11em; text-transform: uppercase; }.loop-stage strong { font: 700 17px/1.36 var(--serif); }.loop-stage > p { grid-column: 1/-1; margin: 0; min-height: 70px; padding: 15px 20px; display: grid; grid-template-columns: 170px 1fr; gap: 20px; align-items: center; border-radius: 6px; background: var(--green-field); }.loop-stage.positive > p { background: var(--warm-field); }.loop-stage > p strong { font-size: 19px; }
</style>
