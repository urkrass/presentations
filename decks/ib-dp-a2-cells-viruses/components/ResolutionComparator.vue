...
<style scoped>
.resolution-comparison{display:grid;grid-template-columns:1.22fr .78fr;gap:42px;min-height:455px;align-items:center}.micrograph-stage{position:relative;height:440px;overflow:hidden;background:#111;cursor:ew-resize;user-select:none}.micrograph-stage>img,.sharp-layer,.sharp-layer img{position:absolute;inset:0;width:100%;height:100%;object-fit:cover}.soft-image{filter:blur(8px) saturate(.58);transform:scale(1.035)}.sharp-layer{overflow:hidden}.sharp-layer img{max-width:none}.stage-label{position:absolute;top:16px;padding:8px 10px;background:rgba(12,12,12,.72);color:#fff;font-size:11px;font-weight:800;letter-spacing:.08em;text-transform:uppercase}.stage-label.resolved{left:16px}.stage-label.unresolved{right:16px}.comparison-handle{position:absolute;top:50%;width:54px;height:54px;display:grid;place-items:center;border-radius:50%;transform:translate(-50%,-50%);background:var(--rust);color:#fff;font:700 24px/1 Georgia,serif;box-shadow:0 5px 16px rgba(0,0,0,.25)}.resolution-copy{display:grid;gap:17px}.resolution-copy h2{margin:0;font:500 38px/1.08 Georgia,serif}.resolution-copy>p:not(.scene-kicker){margin:0;color:var(--muted);font-size:18px;line-height:1.44}.resolution-claim{padding:17px;background:var(--soft-blue);color:var(--ink)!important}.resolution-claim strong{color:var(--blue)}.micrograph-stage:focus-visible{outline:4px solid color-mix(in srgb,var(--blue) 48%,transparent);outline-offset:4px}
</style>
