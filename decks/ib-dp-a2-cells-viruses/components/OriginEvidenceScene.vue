...
<style scoped>
.origin-evidence{display:grid;grid-template-columns:1.2fr .8fr;gap:46px;min-height:500px}.origin-evidence figure{position:relative;margin:0;height:500px;overflow:hidden;border-radius:var(--radius-field);background:#111}.origin-evidence img{width:100%;height:100%;object-fit:cover}.origin-evidence figure.contain img{object-fit:contain;background:#fff}.origin-evidence figcaption{position:absolute;left:18px;bottom:16px;padding:8px 11px;border-radius:var(--radius-control);background:rgba(14,14,14,.72);color:#fff;font-size:11px;font-weight:800;letter-spacing:.08em;text-transform:uppercase}.origin-copy{display:grid;align-content:center;gap:18px}.origin-copy h2{margin:0;font:500 36px/1.12 Georgia,serif}.origin-copy>p:not(.scene-kicker){margin:0;color:var(--muted);font-size:18px;line-height:1.43}.origin-limit{display:grid;gap:6px;padding:15px 17px;border-radius:var(--radius-field);background:var(--paper-deep)}.origin-limit strong{color:var(--rust);font-size:11px;letter-spacing:.1em;text-transform:uppercase}.origin-switcher{display:grid;grid-template-columns:repeat(3,1fr);gap:8px}.origin-switcher button{min-height:54px;padding:9px 10px;border:0;border-radius:var(--radius-field);background:var(--paper-deep);color:var(--muted);font-weight:750;text-align:left;cursor:pointer;text-transform:capitalize}.origin-switcher button span{display:block;margin-bottom:4px;color:var(--rust);font-size:10px;letter-spacing:.08em}.origin-switcher button.active{background:var(--blue);color:#fff}.origin-switcher button.active span{color:#dce9f1}button:focus-visible{outline:3px solid color-mix(in srgb,var(--blue) 48%,transparent);outline-offset:3px}
</style>
