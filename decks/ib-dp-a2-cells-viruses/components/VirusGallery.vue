...
<style scoped>
.virus-gallery{display:grid;grid-template-columns:1.16fr .84fr;gap:46px;min-height:500px}.virus-gallery figure{position:relative;margin:0;height:500px;overflow:hidden;background:#111}.virus-gallery img{width:100%;height:100%;object-fit:cover}.virus-gallery figcaption{position:absolute;left:18px;bottom:15px;background:rgba(0,0,0,.67);color:#fff;padding:8px 11px;font-size:12px;font-weight:800;letter-spacing:.08em;text-transform:uppercase}.virus-copy{display:grid;align-content:center;gap:17px}.virus-copy h2{margin:0;font:500 44px/1 Georgia,serif;text-transform:capitalize}.virus-copy dl{margin:0;display:grid;gap:8px}.virus-copy dl div{display:grid;grid-template-columns:86px 1fr;gap:14px}.virus-copy dt{color:var(--rust);font-size:12px;font-weight:800;letter-spacing:.08em;text-transform:uppercase}.virus-copy dd{margin:0;color:var(--ink);font-weight:700}.virus-copy>p:not(.scene-kicker){margin:0;color:var(--muted);font-size:17px;line-height:1.42}.virus-switcher{display:flex;gap:18px;flex-wrap:wrap}.virus-switcher button{padding:8px 0;border:0;border-bottom:3px solid transparent;background:transparent;color:var(--muted);font-weight:700;cursor:pointer}.virus-switcher button.active{color:var(--blue);border-color:var(--blue)}button:focus-visible{outline:3px solid color-mix(in srgb,var(--blue) 48%,transparent);outline-offset:3px}
</style>
